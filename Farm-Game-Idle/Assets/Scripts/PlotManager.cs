...
public class PlotManager : MonoBehaviour
{
            ...
            switch (fm.selectedTool)
            {
                ...
                case 2:
                    if(fm.money >= 10 && isBought)
                    {
                        ...
                        if(speed < 5)
                        {
                            speed += 1f; //fertilizer yeterli para varsa her týklandýðýnda processi 2 kat hýzlandýrýr.
                        }
                    }
                    break;
                case 3:
    ...
    void UpdatePlant()
    {
        ...
        plantCollider.offset = new Vector2(0, plant.bounds.size.y / 2); //bitkilerin sprite pivot noktasý bottom olduðu için düzeltme yaptýk.
    }
}
